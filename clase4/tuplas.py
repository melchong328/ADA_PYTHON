...
# Acceder a los elementos de la tuplo por su indice (posicion)
print("Primer elemento de la tupla: ", tupla_mixta[0])
print("Segundo elemento de la tupla: ", tupla_mixta[1])
print("Terce elemento de la tupla: ", tupla_mixta[2])
...
# Explicación clara de unmutabilidad
print("Si intentamos hacer tupla_mixta[0] = 10, Python mostrara porque no se puede cambiar ningun elementos de una tupla ")
